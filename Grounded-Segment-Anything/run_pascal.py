...
def get_argparser():
    ...
    parser.add_argument("--sam_version", type=str,
                        default="vit_h", required=False, 
...
palette = get_palette_for('pascal')
...
if __name__ == "__main__":
    ...
    image_root_path = os.path.join(devkit_path, 'VOC2012/JPEGImages')
    imageset_path = os.path.join(devkit_path, 'VOC2012/ImageSets/Segmentation', 'train.txt')
